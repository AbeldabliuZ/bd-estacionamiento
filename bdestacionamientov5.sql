...
-- Started on 2025-05-16 23:46:40
...
--
-- TOC entry 3197 (class 2604 OID 17051)
-- Name: relacioncli nro_contrato; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.relacioncli ALTER COLUMN nro_contrato SET DEFAULT nextval('public.relacioncli_id_relacion_seq'::regclass);
...
--
-- TOC entry 3361 (class 0 OID 16990)
-- Dependencies: 210
...
--
-- TOC entry 3363 (class 0 OID 16997)
-- Dependencies: 212
...
--
-- TOC entry 3367 (class 0 OID 17018)
-- Dependencies: 216
...
--
-- TOC entry 3371 (class 0 OID 32779)
-- Dependencies: 220
...
--
-- TOC entry 3369 (class 0 OID 17048)
-- Dependencies: 218
...
--
-- TOC entry 3365 (class 0 OID 17004)
-- Dependencies: 214
...
SELECT pg_catalog.setval('public.clientes_id_client_seq', 5, true);
...
SELECT pg_catalog.setval('public.empleados_id_emp_seq', 5, true);
...
SELECT pg_catalog.setval('public.mantenimiento_id_mantenimiento_seq', 10, true);
...
SELECT pg_catalog.setval('public.vehiculo_id_vehiculo_seq', 6, true);
...
--
-- TOC entry 3214 (class 2606 OID 32784)
...
--
-- TOC entry 3212 (class 2606 OID 17053)
...
--
-- TOC entry 3216 (class 2606 OID 17025)
...
--
-- TOC entry 3219 (class 2606 OID 32790)
...
--
-- TOC entry 3220 (class 2606 OID 32785)
...
--
-- TOC entry 3217 (class 2606 OID 17054)
...
--
-- TOC entry 3215 (class 2606 OID 17012)
...
-- Completed on 2025-05-16 23:46:41
