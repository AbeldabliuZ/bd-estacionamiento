...
-- Started on 2025-05-17 02:39:04
...
--
-- TOC entry 835 (class 1247 OID 16984)
...
-- Name: vista_mantenimiento; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vista_mantenimiento AS
 SELECT m.id_espacio AS espacio,
    m.id_emp AS personal,
    emp.nombre_emp AS nombre_personal,
    emp.apellido_emp AS apellido_personal,
    m.fecha
   FROM (public.mantenimiento m
     LEFT JOIN public.empleados emp ON ((m.id_emp = emp.id_emp)));


ALTER VIEW public.vista_mantenimiento OWNER TO postgres;

--
-- TOC entry 221 (class 1259 OID 32881)
-- Name: vista_parkin; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vista_parkin AS
 SELECT e.id_espacio AS parking,
    e.estado,
    ...
    emp.id_emp AS id_oficial,
    emp.nombre_emp AS nombre_oficial,
    emp.apellido_emp AS apellido_oficial
   FROM ((((public.espacios e
     JOIN public.vehiculo v ON ((e.id_vehiculo = v.id_vehiculo)))
     JOIN public.clientes c ON ((v.id_client = c.id_client)))
     JOIN public.relacioncli r ON ((r.id_client = c.id_client)))
     JOIN public.empleados emp ON ((r.id_emp = emp.id_emp)));


ALTER VIEW public.vista_parkin OWNER TO postgres;

--
-- TOC entry 3200 (class 2604 OID 16993)
...
--
-- TOC entry 3201 (class 2604 OID 17000)
...
--
-- TOC entry 3203 (class 2604 OID 17021)
...
--
-- TOC entry 3206 (class 2604 OID 32782)
...
--
-- TOC entry 3202 (class 2604 OID 17007)
...
--
-- TOC entry 3373 (class 0 OID 16990)
-- Dependencies: 210
...
--
-- TOC entry 3375 (class 0 OID 16997)
-- Dependencies: 212
...
--
-- TOC entry 3379 (class 0 OID 17018)
-- Dependencies: 216
...
--
-- TOC entry 3383 (class 0 OID 32779)
-- Dependencies: 220
...
--
-- TOC entry 3381 (class 0 OID 17048)
-- Dependencies: 218
...
--
-- TOC entry 3377 (class 0 OID 17004)
-- Dependencies: 214
...
--
-- TOC entry 3208 (class 2606 OID 16995)
...
--
-- TOC entry 3220 (class 2606 OID 32879)
...
--
-- TOC entry 3210 (class 2606 OID 17002)
...
--
-- TOC entry 3216 (class 2606 OID 17024)
...
--
-- TOC entry 3224 (class 2606 OID 32784)
...
--
-- TOC entry 3222 (class 2606 OID 17053)
...
--
-- TOC entry 3212 (class 2606 OID 17011)
...
--
-- TOC entry 3214 (class 2606 OID 17009)
...
--
-- TOC entry 3226 (class 2606 OID 17025)
...
--
-- TOC entry 3229 (class 2606 OID 32790)
...
--
-- TOC entry 3230 (class 2606 OID 32785)
...
--
-- TOC entry 3227 (class 2606 OID 17054)
...
--
-- TOC entry 3228 (class 2606 OID 17059)
...
--
-- TOC entry 3225 (class 2606 OID 17012)
...
-- Completed on 2025-05-17 02:39:05
